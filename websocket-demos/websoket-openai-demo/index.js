...
if (!OPENAI_API_KEY) {
    console.error('The OpenAI API key is missing. Please add it in the .env file.');
    process.exit(1);
}
...
const SYSTEM_MESSAGE = 'You are AI assistant who loves to help with any questions asked by the caller.';
const VOICE = 'alloy';
